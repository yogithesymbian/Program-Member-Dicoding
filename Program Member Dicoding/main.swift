...
//
//  Created by Yogi Arif Widodo on 18/06/22.
//
...
// MARK: Mendapatkan input dari pengguna dengan type integer
...
// MARK: Mengimplementasikan StudentProtocol dan Person ke kelas Student
...
member.school = school == "" ? "polnes" : school
